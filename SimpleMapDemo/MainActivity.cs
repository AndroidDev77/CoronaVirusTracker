...
namespace CoronaVirusTracker
{
    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        static readonly List<ActivityMetaData> SampleMetaDataList = new List<ActivityMetaData>
                                                                          {
                                                                              new ActivityMetaData(Resource.String.activity_label_mapwithmarkers,
                                                                                                         Resource.String
                                                                                                             .activity_description_mapwithmarkers,
                                                                                                         typeof(MapWithMarkersActivity)),
                                                                              new
                                                                                  ActivityMetaData(Resource.String.activity_label_mapwithoverlays,
                                                                                                         Resource.String
        ...
        void InitializeListView()
        {
            ...
            {
                listAdapter = new ListAdapter(this, SampleMetaDataList);
            }
            else
            {
